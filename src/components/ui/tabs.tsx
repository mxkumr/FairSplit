...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-start gap-1 rounded-2xl bg-card p-1 text-muted-foreground shadow-soft w-full overflow-x-auto border border-border",
      className,
    )}
    {...props}
  />
